/* Use this header with source C backend */
#ifndef AUTOREVISION_DECLR_H
#define AUTOREVISION_DECLR_H

extern const char *VCS_TYPE;
extern const char *VCS_BASENAME;
extern const char *VCS_UUID;
extern const int VCS_NUM;
